...
class Blockchain(object):
    def __init__(self):
        ...
        self.new_block(previous_hash="Hello Blockchain", nonce=100)
...
blockchain.new_block(12345) # This would be where most of the time taken for the transaction to occur would take place. Here we are simulating what a miner would be
#doing finding a nonce using a brute force method.
